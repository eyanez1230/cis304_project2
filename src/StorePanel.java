...
public final class StorePanel extends JPanel implements ActionListener, ListSelectionListener {
    ...
    private String imagePath = "images/welcome.jpg";
    ...
    public void renderButtons() {
        ...
        listInventoryBtn.setFont(new Font("Verdana", Font.PLAIN, 12));
        addToCartBtn.setForeground(Color.red);
        addToCartBtn.setFont(new Font("Verdana", Font.PLAIN, 12));
        removeFromCartBtn.setForeground(Color.red);
        removeFromCartBtn.setFont(new Font("Verdana", Font.PLAIN, 12));
        viewCartBtn.setForeground(Color.red);
        viewCartBtn.setFont(new Font("Verdana", Font.PLAIN, 12));
        ...
        buttonCommands.setBorder(BorderFactory.createTitledBorder(null, "Commands", TitledBorder.CENTER, TitledBorder.TOP, new Font("Verdana", Font.PLAIN, 14)));
    ...
    public void renderMusicSampler() {
        ...
        previewPlayBtn.setFont(new Font("Verdana", Font.PLAIN, 12));
        previewStopBtn.setFont(new Font("Verdana", Font.PLAIN, 12));

        // Set player commands to the JPanel
        JPanel playerCommands = new JPanel();

        // Create border for the panel
        playerCommands.setBorder(BorderFactory.createTitledBorder(null, "Preview Music", TitledBorder.CENTER, TitledBorder.TOP, new Font("Verdana", Font.PLAIN, 14)));
    ...
    public void renderListView() {
        ...
        inventoryList.setBorder(BorderFactory.createTitledBorder(null, "Inventory Items", TitledBorder.LEFT, TitledBorder.TOP, new Font("Verdana", Font.PLAIN, 14)));
        inventoryList.setFont(new Font("Verdana", Font.PLAIN, 14));
    ...
    public void renderDetailsView() {
        ...
        itemDetails = new JTextArea(9, 69);

        JScrollPane areaScrollPane = new JScrollPane(itemDetails);
        areaScrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);

        itemDetails.setFont(new Font("Verdana", Font.PLAIN, 14));
        itemDetails.setEditable(false);
        itemDetails.setBorder(BorderFactory.createTitledBorder(null, "Product Details", TitledBorder.LEFT, TitledBorder.TOP, new Font("Verdana", Font.PLAIN, 14)));
    ...
    public void renderProductImage() {
        ...
        java.net.URL imgURL = StorePanel.class.getResource(imagePath);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == listInventoryBtn) {
            ...
            // Change what border reads
            inventoryList.setBorder(BorderFactory.createTitledBorder("Items in Cart"));
            ...
            String musicFile = "preview/" + product.name + ".wav";
    ...
    public void playAudio(String songfile) {
        try {
            ...
            URL url = this.getClass().getResource(songfile);
