...
public class Video extends Product {
    ...
    // Class consutrctor
    Video(String ID, String name, String genre, String medium, String rating, String principalActors, String director, String runningTime, String format, String year, int qty, String imageURL) {
